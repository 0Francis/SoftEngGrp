...
<head>
    ...
    <title>Edu Bridge - Youth Login</title>
    <style>
        ...
        .login-btn {
            ...
            transition: all 0.3s ease;
            margin-top: 10px;
            animation: fadeInUp 1s ease-out 0.7s both, pulseGlow 2s ease-in-out infinite 0.8s;
        }
...
<body>
    ...
    <section class="login-section">
        ...
        <form id="youthLoginForm" action="youth-login-handler.php" method="POST">
